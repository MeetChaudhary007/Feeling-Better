...
<head>
  ...
  <style>
    ...
    /* Style for the second slide image (Healthy Lifestyle) */
    .rounded-img {
      border-radius: 15px;
      /* Adjust this value to make the corners more or less rounded */
      box-shadow: 0px 5px 15px rgba(0, 0, 0, 0.1);
      /* Optional: adds a subtle shadow */
      object-fit: cover;
      /* Ensures the image is not stretched */
      max-height: 300px;
      /* Optional: limit the image height */
      width: 100%;
      /* Ensure the image takes full width within its container */
    }

    /* Style for the third slide image (Square with Rounded Corners) */
    .square-rounded-img {
      border-radius: 20px;
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container pt-3">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex  flex-column flex-lg-row align-items-center w-100 justify-content-between">
              ...
              <ul id="autocomplete-results" style="display:none; position: absolute; background-color: white; border: 1px solid #ccc; max-height: 200px; overflow-y: auto;"></ul>
    ...
    <section class="slider_section position-relative">
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="5000">
        ...
        <div class="carousel-inner">
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                  <div class="detail-box">
                    ...
                    <div>
                      <a href="medicine.php" class="btn btn-primary">Buy Now</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <!-- Second Slide (Updated) -->
          <div class="carousel-item">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img src="images/healthy-lifestyle.jpg" alt="Healthy Lifestyle" class="img-fluid rounded-img">
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="detail-box">
                    <h1>
                      ...
                      <span>Embrace a Healthy Life</span>
                    </h1>
                    <p>
                      We provide a range of health supplements and natural products to help you feel your best. Start
                      your journey to better health today!
                    </p>
                    <div>
                      <a href="medicine.php" class="btn btn-success">Explore Products</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <!-- Third Slide (Updated - General Healthcare Focus) -->
          <div class="carousel-item">
            <div class="container">
              <div class="row">
                <div class="col-md-4">
                  <div class="img-box">
                    <img src="images/medicine-care.jpg" alt="Reliable Healthcare" class="img-fluid square-rounded-img">
                  </div>
                </div>
                <div class="col-md-8">
                  <div class="detail-box">
                    <h1>
                      ...
                      <span>Reliable Medicine for Every Need</span>
                    </h1>
                    <p>
                      We offer a wide selection of trusted medicines and healthcare products. Whether it's for daily
                      wellness or specific health conditions, we are here to provide you with the best.
                    </p>
                    <div>
                      <a href="medicine.php" class="btn btn-danger">Shop Now</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="feature_container">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Whether you require prescription drugs, over-the-counter medications, or health and wellness products,
        ...
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Goverment Licensed Medicines are provided here.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Whatever may be the situation, we're here 24/7 to support you.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-5 offset-md-2">
          <div class="detail-box">
            ...
            <p>
              Grab the 10% Discount Offer Now
            </p>
            <div>
              <a href="">
                Buy Now
